		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="{{ route('issues.create') }}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Thêm issue</span></a>
				...
				<tbody>
                    @foreach ($issues as $issue)
                        <tr>
                            ...
                            <td>{{$issue->status}}</td>
                            <td>
                                <a href="{{ route('issues.edit', $issue->id) }}" class="btn btn-primary" style="font-weight: 300; color: white">Sửa</a>
